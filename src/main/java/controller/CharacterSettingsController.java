...
public class CharacterSettingsController extends SettingsController {
    ...
    public void initialize(){
        ...
        chr1 = new Image(Paths.get(("./resources/images/mainCharacter/character1_0.gif")).toUri().toString());
        chr2 = new Image(Paths.get(("./resources/images/mainCharacter/character2_0.gif")).toUri().toString());
        chr3 = new Image(Paths.get(("./resources/images/mainCharacter/dance.gif")).toUri().toString());
