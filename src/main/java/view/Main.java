...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.getIcons().add(new Image(Paths.get("/resources/images/background/icon.png").toUri().toString()));

        mainMenuScene = initializeScene("main_menu.fxml");
        //Set background via css
        mainMenuScene.getStylesheets().add(this.getClass().getClassLoader().getResource("styleMainMenu.css").toExternalForm());

        howToPlayScene = initializeScene("how_to_play.fxml");
        howToPlayScene.getStylesheets().add(this.getClass().getClassLoader().getResource("styleOtherMenus.css").toExternalForm());

        creditsScene = initializeScene("credits.fxml");
        creditsScene.getStylesheets().add(this.getClass().getClassLoader().getResource("styleOtherMenus.css").toExternalForm());

        exitScene = initializeScene("exit.fxml");
        exitScene.getStylesheets().add(this.getClass().getClassLoader().getResource("styleOtherMenus.css").toExternalForm());

        settingsScene = initializeScene("settings.fxml");
        settingsScene.getStylesheets().add(this.getClass().getClassLoader().getResource("styleOtherMenus.css").toExternalForm());

        highScoreScene = initializeScene("high_scores.fxml");
        highScoreScene.getStylesheets().add(this.getClass().getClassLoader().getResource("styleOtherMenus.css").toExternalForm());

        soundSettingsScene = initializeScene("sound_settings.fxml");
        soundSettingsScene.getStylesheets().add(this.getClass().getClassLoader().getResource("styleOtherMenus.css").toExternalForm());

        buttonSettingsScene = initializeScene("button_settings.fxml");
        buttonSettingsScene.getStylesheets().add(this.getClass().getClassLoader().getResource("styleOtherMenus.css").toExternalForm());

        characterSettingsScene = initializeScene("character_settings.fxml");
        characterSettingsScene.getStylesheets().add(this.getClass().getClassLoader().getResource("styleOtherMenus.css").toExternalForm());

        difficultyScene = initializeScene("difficulty_screen.fxml");
        difficultyScene.getStylesheets().add(this.getClass().getClassLoader().getResource("styleOtherMenus.css").toExternalForm());
