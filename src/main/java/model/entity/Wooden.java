...
public class Wooden extends Bar {
    ...
    public Wooden(){
        ...
        images[0] = new Image(Paths.get("./resources/images/gameObject/bar_l2.png").toUri().toString());
        images[1] = new Image(Paths.get("./resources/images/gameObject/bar_m2.png").toUri().toString());
        images[2] = new Image(Paths.get("./resources/images/gameObject/bar_r2.png").toUri().toString());
