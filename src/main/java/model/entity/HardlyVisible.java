...
public class HardlyVisible extends Bar {
	...
	public HardlyVisible(){
        ...
        images[0] = new Image(Paths.get("./resources/images/gameObject/bar_l1.png").toUri().toString());
        images[1] = new Image(Paths.get("./resources/images/gameObject/bar_m1.png").toUri().toString());
        images[2] = new Image(Paths.get("./resources/images/gameObject/bar_r1.png").toUri().toString());
