...
public class Icy extends Bar {
	...
	public Icy(){
	    ...
	    images[0] = new Image(Paths.get("./resources/images/gameObject/bar_l3.png").toUri().toString());
        images[1] = new Image(Paths.get("./resources/images/gameObject/bar_m3.png").toUri().toString());
        images[2] = new Image(Paths.get("./resources/images/gameObject/bar_r3.png").toUri().toString());
